        ...
        {showTop && (
          <motion.button
            ...
            style={{
              ...
              border: "none",
              background:
                "linear-gradient(to top, rgba(255,255,255,0.14) 0%, rgba(255,255,255,0.04) 60%, rgba(255,255,255,0) 100%)",
            ...
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLElement).style.background =
                "linear-gradient(to top, rgba(255,255,255,0.22) 0%, rgba(255,255,255,0.07) 60%, rgba(255,255,255,0) 100%)";
